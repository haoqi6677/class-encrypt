...
public class ClassWriter implements Closeable {
    ...
    public byte[] writeToByte(ClassFile classFile) throws IOException {
        this.classFile = classFile;
        out.reset();
        write();
    ...
    protected static class ConstantPoolWriter
        ...
        public Integer visitDynamicConstant(ConstantPool.CONSTANT_Dynamic_info info, ClassOutputStream out) {
            out.writeShort(info.bootstrap_method_attr_index);
            out.writeShort(info.name_and_type_index);
            return 1;
        }
        ...
        @Override
        public Integer visitModule(ConstantPool.CONSTANT_Module_info info, ClassOutputStream out) {
            out.writeShort(info.name_index);
            return 1;
        }
        ...
        @Override
        public Integer visitPackage(ConstantPool.CONSTANT_Package_info info, ClassOutputStream out) {
            out.writeShort(info.name_index);
            return 1;
        }
