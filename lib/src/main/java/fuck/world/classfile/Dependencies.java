...
public class Dependencies {
    ...
    static class ClassDependencyFinder extends BasicDependencyFinder {
        public Iterable<? extends Dependency> findDependencies(ClassFile classfile) {
            Dependencies.BasicDependencyFinder.Visitor v = new Dependencies.BasicDependencyFinder.Visitor(classfile);
    ...
    static abstract class BasicDependencyFinder implements Dependency.Finder {
        ...
        class Visitor implements ConstantPool.Visitor<Void, Void>, Type.Visitor<Void, Void> {
            ...
            @Override
            public Void visitDynamicConstant(ConstantPool.CONSTANT_Dynamic_info info, Void aVoid) {
                return null;
            }
            ...
            public Void visitModule(ConstantPool.CONSTANT_Module_info info, Void p) {
                return null;
            }
            ...
            public Void visitPackage(ConstantPool.CONSTANT_Package_info info, Void p) {
                return null;
            }
