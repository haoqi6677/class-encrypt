...
public abstract class Type {
    ...
    public static class MethodType extends Type {
        ...
        public MethodType(List<? extends Type.TypeParamType> typeParamTypes,
    ...
    public static class ClassSigType extends Type {
        public ClassSigType(List<Type.TypeParamType> typeParamTypes, Type superclassType,
    ...
    public static class ClassType extends Type {
        public ClassType(Type.ClassType outerType, String name, List<Type> typeArgs) {
        ...
        public final Type.ClassType outerType;
        public final String name;
