...
public class NestMembers_attribute extends Attribute {
    ...
    public ConstantPool.CONSTANT_Class_info[] getChildren(ConstantPool constant_pool) throws ConstantPoolException {
        return IntStream.of(members_indexes)
                ...
                }).toArray(ConstantPool.CONSTANT_Class_info[]::new);
    }
