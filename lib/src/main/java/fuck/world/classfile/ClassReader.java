...
public class ClassReader implements Closeable{
    ...
    ClassReader(ClassFile classFile, byte[] classfileBuffer, Attribute.Factory attributeFactory) throws IOException {
        this.classFile = Objects.requireNonNull(classFile);
        this.attributeFactory = Objects.requireNonNull(attributeFactory);
        this.in = new DataInputStream(new BufferedInputStream(new ByteArrayInputStream(classfileBuffer)));
    }
