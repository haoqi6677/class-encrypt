...
public class ClassTranslator
    ...
    public ConstantPool.CPInfo visitClass(ConstantPool.CONSTANT_Class_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp)
                ...
                info2 = new ConstantPool.CONSTANT_Class_info(cp2, info.name_index);
    ...
    public ConstantPool.CPInfo visitFieldref(ConstantPool.CONSTANT_Fieldref_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp)
                ...
                info2 = new ConstantPool.CONSTANT_Fieldref_info(cp2, info.class_index, info.name_and_type_index);
            translations.put(info, info2);
        }
        return info;
    }
    ...
    public ConstantPool.CPInfo visitInterfaceMethodref(ConstantPool.CONSTANT_InterfaceMethodref_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp)
                ...
                info2 = new ConstantPool.CONSTANT_InterfaceMethodref_info(cp2, info.class_index, info.name_and_type_index);
            translations.put(info, info2);
        }
        return info;
    }
    ...
    public ConstantPool.CPInfo visitInvokeDynamic(ConstantPool.CONSTANT_InvokeDynamic_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp) {
                ...
                info2 = new ConstantPool.CONSTANT_InvokeDynamic_info(cp2, info.bootstrap_method_attr_index, info.name_and_type_index);
            }
            translations.put(info, info2);
        }
        return info;
    ...
    public ConstantPool.CPInfo visitDynamicConstant(ConstantPool.CONSTANT_Dynamic_info info, Map<Object, Object> translations) {
        ConstantPool.CONSTANT_Dynamic_info info2 = (ConstantPool.CONSTANT_Dynamic_info) translations.get(info);
        if (info2 == null) {
            ConstantPool cp2 = translate(info.cp, translations);
            if (cp2 == info.cp) {
                info2 = info;
            } else {
                info2 = new ConstantPool.CONSTANT_Dynamic_info(cp2, info.bootstrap_method_attr_index, info.name_and_type_index);
            }
            translations.put(info, info2);
        }
        return info;
    ...
    public ConstantPool.CPInfo visitMethodref(ConstantPool.CONSTANT_Methodref_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp)
                ...
                info2 = new ConstantPool.CONSTANT_Methodref_info(cp2, info.class_index, info.name_and_type_index);
            translations.put(info, info2);
        }
        return info;
    }
    ...
    public ConstantPool.CPInfo visitMethodHandle(ConstantPool.CONSTANT_MethodHandle_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp) {
                ...
                info2 = new ConstantPool.CONSTANT_MethodHandle_info(cp2, info.reference_kind, info.reference_index);
            }
            translations.put(info, info2);
        }
        return info;
    ...
    public ConstantPool.CPInfo visitMethodType(ConstantPool.CONSTANT_MethodType_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp) {
                ...
                info2 = new ConstantPool.CONSTANT_MethodType_info(cp2, info.descriptor_index);
            }
            translations.put(info, info2);
        }
        return info;
    ...
    @Override
    public ConstantPool.CPInfo visitModule(ConstantPool.CONSTANT_Module_info info, Map<Object, Object> translations) {
        ConstantPool.CONSTANT_Module_info info2 = (ConstantPool.CONSTANT_Module_info) translations.get(info);
        if (info2 == null) {
            ConstantPool cp2 = translate(info.cp, translations);
            if (cp2 == info.cp)
                info2 = info;
            else
                info2 = new ConstantPool.CONSTANT_Module_info(cp2, info.name_index);
            translations.put(info, info2);
        }
        return info;
    }
    ...
    public ConstantPool.CPInfo visitNameAndType(ConstantPool.CONSTANT_NameAndType_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp)
                ...
                info2 = new ConstantPool.CONSTANT_NameAndType_info(cp2, info.name_index, info.type_index);
            translations.put(info, info2);
        }
        return info;
    }
    ...
    @Override
    public ConstantPool.CPInfo visitPackage(ConstantPool.CONSTANT_Package_info info, Map<Object, Object> translations) {
        ConstantPool.CONSTANT_Package_info info2 = (ConstantPool.CONSTANT_Package_info) translations.get(info);
        if (info2 == null) {
            ConstantPool cp2 = translate(info.cp, translations);
            if (cp2 == info.cp)
                info2 = info;
            else
                info2 = new ConstantPool.CONSTANT_Package_info(cp2, info.name_index);
            translations.put(info, info2);
        }
        return info;
    }
    ...
    public ConstantPool.CPInfo visitString(ConstantPool.CONSTANT_String_info info, Map<Object, Object> translations) {
        ...
        if (info2 == null) {
            ...
            if (cp2 == info.cp)
                ...
                info2 = new ConstantPool.CONSTANT_String_info(cp2, info.string_index);
            translations.put(info, info2);
        }
        return info;
    }
